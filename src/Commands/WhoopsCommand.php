...
namespace Fluent\Whoops\Commands;

use CodeIgniter\CLI\BaseCommand;
use CodeIgniter\CLI\CLI;
use Config\Autoload;

class WhoopsCommand extends BaseCommand
{
    /**
     ...
     * @var string
     */
    protected $description = 'Publish config whoops to folder App\Config';
     ...
     * @var string
     */
    protected $usage = 'whoops:publish';
    ...
    {
        $path = "{$this->sourcePath}/Config/Whoops.php";

        $content = file_get_contents($path);
        $content = str_replace('namespace Fluent\Whoops\Config', 'namespace App\Config', $content);

        $this->writeFile('Config/Whoops.php', $content);
    }
